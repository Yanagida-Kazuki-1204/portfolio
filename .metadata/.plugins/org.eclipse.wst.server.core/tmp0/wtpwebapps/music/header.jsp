...
<style type="text/css">
.headerLogo:link { color:#fff; text-decoration:none }
.headerLogo:visited { color:#fff; text-decoration:none }
.headerLogo:hover { color:#fff; text-decoration:none }
.headerLogo:active { color:#fff; text-decoration:none }
</style>
</head>
<body>
...
<header>
<div id="header">
<div id="headertitle"><a class="headerLogo" href="http://localhost:8080/music/HomeAction">MusicEC</a></div>
<div id="header-menu">
<ul>
<s:form id="form" name="form">
	...
	<li><s:submit value="検索" class="submit_btn" onclick="goSearchItemAction();"/><li>
